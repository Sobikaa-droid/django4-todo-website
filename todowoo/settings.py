...
SECRET_KEY = 'django-insecure-)^4(8w#2ba7c#^1hixmq2hxc&=q(sl3x(oqm#s^0xy7$g)g$@x'
...
LOGIN_URL = '/log-in'  # redirects to login page if user tries to access todos without being logged in
